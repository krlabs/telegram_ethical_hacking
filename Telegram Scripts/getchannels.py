# getchannels.py
#
# Скрипт на базі Telegram API (Telethon) отримує список доступних для парсингу Telegram-ресурсів в обліковому записі користувача (get_telegram_resources_lists): чати, канали, групи, юзери.
